...
(http://open.canada.ca/data/en/dataset/b8c61621-e541-4e4c-8654-48152519a30a "Federal Heritage Designations dabase")
...
4. Run the Macro script - unless there are problems, the lat/long fields should propagate.
