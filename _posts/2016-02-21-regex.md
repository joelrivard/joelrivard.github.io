...
--------------------------------------
Regular Expressions can be used on text documents that have some sort of unstructured or loose patterns. Users need to be aware of the following before beginning to use Regular Expressions.
