...
1. Collect or ensure that you have a comma-separated file (.csv) with values of x,y,z. ![Comma seperated values](images/csv.png "Comma seperated values"). This is displayed in a text editor, but it can also be viewed as tabular data.
